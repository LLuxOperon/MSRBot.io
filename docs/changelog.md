...
- **Project rebrand and repository migration:** moved to `LLuxOperon/MSRBot.io`; redirects active for previous repo and domain.
...
- **Identity & icon:** replaced legacy MSR icon with minimalist “Murderbot Penguin” SVG favicon; scalable and consistent across all resolutions.
